...
TEST_CASE("query_cache_filters", "[simple]") {
  World w;
  SETUP_INDEX;
  ...
  w.Get(e2).Get<E>().x = 1;
  w.Get(e2).Get<E>().z = "abc";

  w.Get(e3).Get<F>().status = Status::S2;

  w.Get(e4).Get<D>().x = 7;
  w.Get(e4).Get<E>().x = 1;
  w.Get(e4).Get<E>().z = "abc";

  w.Get(e5).Get<D>().x = 4;
  w.Get(e5).Get<E>().x = 1;
  w.Get(e5).Get<E>().z = "abc";
  ...
  REQUIRE(m2 == decltype(m2){e2, e4, e5});
  REQUIRE(m3 == decltype(m3){e4, e5});
  REQUIRE(m4 == decltype(m4){e5});
  ...
  c3.ForEach([&z3](EntityReference &e) { z3.insert(e.GetId()); });
  c4.ForEach([&z4](EntityReference &e) { z4.insert(e.GetId()); });
  REQUIRE(z1 == decltype(z1){e1});
  REQUIRE(z2 == decltype(z2){e2, e4, e5});
  REQUIRE(z3 == decltype(z3){e4, e5});
  ...
  w.Get(e6).Get<D>().x = 5;
  w.Get(e6).Get<E>().x = 11;
  w.Get(e6).Get<E>().z = "xyz";
  w.Get(e6).Get<F>().status = Status::S2;
  w.Get(e4).Get<D>().x = 1;
  w.Get(e4).Get<E>().z = "xyz";
  ...
  c3.ForEach([&z3](EntityReference &e) { z3.insert(e.GetId()); });
  c4.ForEach([&z4](EntityReference &e) { z4.insert(e.GetId()); });
  REQUIRE(z1 == decltype(z1){e1, e4, e6});
  REQUIRE(z2 == decltype(z2){e2, e5});
  REQUIRE(z3 == decltype(z3){e5});
  REQUIRE(z4 == decltype(z4){e6});
}
